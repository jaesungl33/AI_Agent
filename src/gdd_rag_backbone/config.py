...
# Project root directory (go up from src/gdd_rag_backbone/config.py)
...
# Default paths (using new data/ directory structure)
DEFAULT_WORKING_DIR = PROJECT_ROOT / "data" / "rag_storage"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "data" / "output"
DEFAULT_DOCS_DIR = PROJECT_ROOT / "data" / "gdd_documents"

# RAG-Anything configuration defaults
DEFAULT_PARSER = "mineru"  # Options: "mineru" or "docling"
